...
// This is a login screen. This window opens when the app is opened.
...
public class LoginActivity extends AppCompatActivity {
    ...
    // Checks if username and password match and opens main window.
    ...
    // returns true and if not returns false. If the username and password are a match, it adds the users info to ActiveUserData for later use.
